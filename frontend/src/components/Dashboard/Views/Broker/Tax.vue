        ...
        <div class="card">
          ...
          <div class="card-body table-full-width">
            <el-table name="tax_items" :data="this.closedOrders" :default-sort="{property: 'id', order: 'descending'}"
              ...
              <el-table-column label="Symbol" property="name"></el-table-column>
  ...
  methods: {
    fillTaxes(res) {
      ...
      this.closedOrders.forEach(function (s) {
        ...
        s.benefits_net = s.shares * s.price;
        s.benefits = s.shares * s.price - s.fees;
        ...
        s.children.forEach(function (c) {
          ...
          s.benefits_net -= c.price * c.shares;
          s.benefits -= c.price * c.shares + c.partial_fee; //- (c.fees/(s.shares/c.shares));
          c.cost = c.shares * c.price + c.fees;
        });
